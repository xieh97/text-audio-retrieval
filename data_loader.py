...
def get_train_data_loader(data_set, batch_size=64, n_workers=10,
                          queue_random_sampling=False, targets=None, collate_fun=None, shuffle=True):
    if targets is None:
...
def get_eval_data_loader(data_set, batch_size_eval=32, n_workers=10,
                         collate_fun=None, shuffle=False, distributed=False):
    if distributed:
